...
MyVector2 MyVector2_Zero()                           { MyVector2 result; result.x = 0.0f;         result.y = 0.0f;           return result; }
MyVector2 MyVector2_Add(MyVector2 v1, MyVector2 v2)  { MyVector2 result; result.x = v1.x + v2.x;  result.y = v1.y + v2.y;    return result; }
MyVector2 MyVector2_Sub(MyVector2 v1, MyVector2 v2)  { MyVector2 result; result.x = v1.x - v2.x;  result.y = v1.y - v2.y;    return result; }
MyVector2 MyVector2_Mul(MyVector2 v1, float value)   { MyVector2 result; result.x = v1.x * value; result.y = v1.y * value;   return result; }
MyVector2 MyVector2_Div(MyVector2 v1, float value)   { MyVector2 result; result.x = v1.x / value; result.y = v1.y / value;   return result; }
MyVector2 MyVector2_Abs(MyVector2 v1)                { MyVector2 result; result.x = fabs(v1.x);   result.y = fabs(v1.y);     return result; }
MyVector2 MyVector2_Negate(MyVector2 v1)             { MyVector2 result; result.x = -v1.x;        result.y = -v1.y;          return result; }
